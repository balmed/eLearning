...
<?php
	...
	echo '<div id="not" style="width:325px" class="not"><div class="mes3" id="not2"> Bienvenue sur la Plate-forme d&#233nseignement  a distance (EAD) de Lyc&#233e Qualifiat Moulay el Mehdi Salhi(LQ2MS). Sur ce site vous trouverez des informations sur les fili&#233res,</div></div>';
	echo '<div id="messages" style="display:none;width:220px" class="not"><div class="mes3" id="messages2"></div></div>';
	echo '<div id="ed" style="width:295px" class="not"><div class="mes3" id="ed2">';if($ref == "root"){echo "<a href='admin.php'>Administration</a>";}else{echo "L'administrateur du systeme<br>Prof : Mohamed Balouk"; }
...
echo '<div class="grp">Sciences</div>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Math&#233matique</option>';
echo'<option  id="menu" value="page.php?page=1">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=2">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=3">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=4">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=5">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=6">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';

//echo'<select  id="pet-select" size="1" onChange="location = this.options[this.selectedIndex].value;">';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Informatique</option>';
echo'<option  id="menu" value="page.php?page=7">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=8">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=9">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=10">Tronc Commun</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Physique</option>';
echo'<option  id="menu" value="page.php?page=11">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=12">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=13">3éme Année Secondaire Coll&#233gial</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Sciences de vie et de la terre</option>';
echo'<option  id="menu" value="page.php?page=14">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=14">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=16">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=17">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=18">1ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Education physique</option>';
echo'<option  id="menu" value="page.php?page=19">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=20">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=21">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=22">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=23">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=24">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo '<div class="grp">Littre</div>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Langue francais</option>';
echo'<option  id="menu" value="page.php?page=25">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=26">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=27">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=28">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=29">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=30">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Langue anglais</option>';
echo'<option  id="menu"value="page.php?page=31">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=32">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=33">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=34">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Langue arabe</option>';
echo'<option  id="menu" value="page.php?page=35">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=36">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=37">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=38">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=39">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=40">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Education islamic</option>';
echo'<option  id="menu" value="page.php?page=41">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=42">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=43">3éme Année Secondaire Coll&#233gial</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Tafsir wa hadith</option>';
echo'<option  id="menu"value="page.php?page=44">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=45">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=46">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Fiqh wa ossoul</option>';
echo'<option  id="menu"value="page.php?page=47">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=48">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=49">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Tawtik</option>';
echo'<option  id="menu"value="page.php?page=50">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=51">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=52">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Philosophie</option>';
echo'<option  id="menu"value="page.php?page=53">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=54">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=55">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo'<select id="menu"class="grp" onChange="location = this.options[this.selectedIndex].value;">';
echo'<option value="" >Histoire et géographie</option>';
echo'<option  id="menu" value="page.php?page=56">1er Année Secondaire Coll&#233gial</div></option>';
echo'<option  id="menu" value="page.php?page=57">2éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=58">3éme Année Secondaire Coll&#233gial</option>';
echo'<option  id="menu"value="page.php?page=59">Tronc Commun</option>';
echo'<option  id="menu"value="page.php?page=60">1ème Année Bac Sciences Chariaa</option>';
echo'<option  id="menu"value="page.php?page=61">2ème Année Bac Sciences Chariaa</option>';
echo'</select>';
echo '<div class="grp"> Activit&#233s</div>';
echo '<div id="menu"><a class="menua" href="page.php?page=62">Annonces</a></div>';
echo '<div id="menu"><a class="menua" href="page.php?page=63">Culturelles</a></div>';
echo '<div id="menu"><a class="menua" href="page.php?page=64">Formation</a></div>';
echo '<div id="menu"><a class="menua" href="page.php?page=65">Forum</a></div>';
echo '</div></div>';
		?>
...
<div class="CollapsiblePanelTab" tabindex="1"><span class="menua1">&nbsp Statistique Questionnaire</span></div>
...
<div class="CollapsiblePanelTab" tabindex="0"><span class="menua1">&nbsp Biblioth&#233que </span></div><div class="CollapsiblePanelContent">
<div class="qcm">
...
<div class="CollapsiblePanelTab" tabindex="0"><span class="menua1"><?php  if($ref != "root"){echo "&nbsp Contacter Administrateur";}else{echo "Statistique";} ?></span></div><div class="CollapsiblePanelContent">
<div class="qcm">
